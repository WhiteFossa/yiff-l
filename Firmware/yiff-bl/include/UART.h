 ...
 */
#define YBL_UART_BLOCKING_TRANSFER_TIMEOUT 1000000U

/**
 * If packet isn't received during this time, reset state machine
 */
#define YBL_UART_NON_BLOCKING_RX_TIMEOUT 1000U

/**
 * Possible packet sizes
 */
#define YBL_UART_PACKET_MIN_SIZE 6
#define YBL_UART_PACKET_MAX_SIZE 64
...
extern uint8_t UART_RxPacketBuffer[YBL_UART_PACKET_MAX_SIZE];
...
extern uint8_t UART_ReceivedPacket[YBL_UART_PACKET_MAX_SIZE];
